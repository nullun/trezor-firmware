...
pub mod features {
    ...
    pub enum Capability {
        ...
        Capability_N4W1 = 25,
        // @@protoc_insertion_point(enum_value:hw.trezor.messages.management.Features.Capability.Capability_Algorand)
        Capability_Algorand = 26,
    }
    ...
    impl ::protobuf::Enum for Capability {
        ...
        fn from_i32(value: i32) -> ::std::option::Option<Capability> {
            match value {
                ...
                26 => ::std::option::Option::Some(Capability::Capability_Algorand),
                _ => ::std::option::Option::None
            }
        }
        ...
        fn from_str(str: &str) -> ::std::option::Option<Capability> {
            match str {
                ...
                "Capability_Algorand" => ::std::option::Option::Some(Capability::Capability_Algorand),
                _ => ::std::option::Option::None
            }
        }
        ...
        const VALUES: &'static [Capability] = &[
            ...
            Capability::Capability_Algorand,
        ];
    }
    ...
    impl ::protobuf::EnumFull for Capability {
        ...
        fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
            let index = match self {
                ...
                Capability::Capability_Algorand => 25,
            };
            Self::enum_descriptor().value_by_index(index)
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x19\n\x0fCapability_N4W1\x10\x19\x1a\x04\x80\xa6\x1d\x01\x12\x17\n\
    \x13Capability_Algorand\x10\x1a\x1a\x04\xc8\xf3\x18\x01\"\x0c\n\nLockDev\
