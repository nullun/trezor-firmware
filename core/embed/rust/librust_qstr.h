...
static void _librust_qstrs(void) {
  ...
  MP_QSTR_xpubs;
#if !BITCOIN_ONLY
  MP_QSTR_algorand__access_list;
  MP_QSTR_algorand__accounts;
  MP_QSTR_algorand__amount;
  MP_QSTR_algorand__app_args;
  MP_QSTR_algorand__app_id;
  MP_QSTR_algorand__application;
  MP_QSTR_algorand__application_call;
  MP_QSTR_algorand__applications;
  MP_QSTR_algorand__approval_program;
  MP_QSTR_algorand__args;
  MP_QSTR_algorand__asset;
  MP_QSTR_algorand__asset_config;
  MP_QSTR_algorand__asset_freeze;
  MP_QSTR_algorand__asset_id;
  MP_QSTR_algorand__asset_name;
  MP_QSTR_algorand__asset_receiver;
  MP_QSTR_algorand__asset_sender;
  MP_QSTR_algorand__asset_transfer;
  MP_QSTR_algorand__assets;
  MP_QSTR_algorand__auth_data;
  MP_QSTR_algorand__blind_signing_warning;
  MP_QSTR_algorand__boxes;
  MP_QSTR_algorand__bytes;
  MP_QSTR_algorand__clawback;
  MP_QSTR_algorand__clear_program;
  MP_QSTR_algorand__close_to;
  MP_QSTR_algorand__close_to_warning;
  MP_QSTR_algorand__confirm_transaction;
  MP_QSTR_algorand__create_app;
  MP_QSTR_algorand__create_asset;
  MP_QSTR_algorand__decimals;
  MP_QSTR_algorand__default_frozen;
  MP_QSTR_algorand__destination;
  MP_QSTR_algorand__destroy_warning;
  MP_QSTR_algorand__domain;
  MP_QSTR_algorand__extra_pages;
  MP_QSTR_algorand__falcon_pq;
  MP_QSTR_algorand__fee;
  MP_QSTR_algorand__first_valid;
  MP_QSTR_algorand__foreign_apps;
  MP_QSTR_algorand__foreign_assets;
  MP_QSTR_algorand__freeze;
  MP_QSTR_algorand__freezer;
  MP_QSTR_algorand__frozen;
  MP_QSTR_algorand__genesis_hash;
  MP_QSTR_algorand__genesis_id;
  MP_QSTR_algorand__global_schema;
  MP_QSTR_algorand__group_contains_template;
  MP_QSTR_algorand__group_id;
  MP_QSTR_algorand__group_overview;
  MP_QSTR_algorand__group_transaction;
  MP_QSTR_algorand__holdings;
  MP_QSTR_algorand__key_dilution;
  MP_QSTR_algorand__key_registration;
  MP_QSTR_algorand__last_valid;
  MP_QSTR_algorand__lease;
  MP_QSTR_algorand__local_schema;
  MP_QSTR_algorand__locals;
  MP_QSTR_algorand__manager;
  MP_QSTR_algorand__metadata_hash;
  MP_QSTR_algorand__network;
  MP_QSTR_algorand__non_participation;
  MP_QSTR_algorand__note;
  MP_QSTR_algorand__on_completion;
  MP_QSTR_algorand__participating;
  MP_QSTR_algorand__payment;
  MP_QSTR_algorand__receiver;
  MP_QSTR_algorand__reject_version;
  MP_QSTR_algorand__rekey_to;
  ...
  MP_QSTR_algorand__source;
  MP_QSTR_algorand__state_proof_pk;
  MP_QSTR_algorand__status;
  MP_QSTR_algorand__title;
  MP_QSTR_algorand__total_supply;
  MP_QSTR_algorand__total_units;
  MP_QSTR_algorand__tx_index_template;
  MP_QSTR_algorand__unfreeze;
  MP_QSTR_algorand__unfrozen;
