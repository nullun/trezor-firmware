...
class TR:
    ...
    algorand__access_list: str = "Access list"
    algorand__accounts: str = "Accounts"
    algorand__amount: str = "Amount"
    algorand__app_args: str = "App args"
    algorand__app_id: str = "App ID"
    algorand__application: str = "Application"
    algorand__application_call: str = "Application call"
    algorand__applications: str = "Applications"
    algorand__approval_program: str = "Approval program"
    algorand__args: str = "Args"
    algorand__asset: str = "Asset"
    algorand__asset_config: str = "Asset config"
    algorand__asset_freeze: str = "Asset freeze"
    algorand__asset_id: str = "Asset ID"
    algorand__asset_name: str = "Asset name"
    algorand__asset_receiver: str = "Asset Receiver"
    algorand__asset_sender: str = "Asset Sender"
    algorand__asset_transfer: str = "Asset transfer"
    algorand__assets: str = "Assets"
    algorand__auth_data: str = "Auth data"
    algorand__blind_signing_warning: str = "Blind signing"
    algorand__boxes: str = "Boxes"
    algorand__bytes: str = "bytes"
    algorand__clawback: str = "Clawback"
    algorand__clear_program: str = "Clear program"
    algorand__close_to: str = "Close to"
    algorand__close_to_warning: str = "This transaction will close the account and send remaining funds to the Close To address!"
    algorand__confirm_transaction: str = "Confirm transaction"
    algorand__create_app: str = "Create app"
    algorand__create_asset: str = "Create asset"
    algorand__decimals: str = "Decimals"
    algorand__default_frozen: str = "Default frozen"
    algorand__destination: str = "Destination"
    algorand__destroy_warning: str = "This transaction will destroy the asset. This cannot be undone!"
    algorand__domain: str = "Domain"
    algorand__extra_pages: str = "Extra pages"
    algorand__falcon_pq: str = "FALCON-DET1024 (PQ)"
    algorand__fee: str = "Fee"
    algorand__first_valid: str = "First valid"
    algorand__foreign_apps: str = "Foreign apps"
    algorand__foreign_assets: str = "Foreign assets"
    algorand__freeze: str = "Freeze"
    algorand__freezer: str = "Freezer"
    algorand__frozen: str = "Frozen"
    algorand__genesis_hash: str = "Genesis hash"
    algorand__genesis_id: str = "Genesis ID"
    algorand__global_schema: str = "Global schema"
    algorand__group_contains_template: str = "Group contains {0} transactions"
    algorand__group_id: str = "Group ID"
    algorand__group_overview: str = "Group overview"
    algorand__group_transaction: str = "Group transaction"
    algorand__holdings: str = "Holdings"
    algorand__key_dilution: str = "Key dilution"
    algorand__key_registration: str = "Key registration"
    algorand__last_valid: str = "Last valid"
    algorand__lease: str = "Lease"
    algorand__local_schema: str = "Local schema"
    algorand__locals: str = "Locals"
    algorand__manager: str = "Manager"
    algorand__metadata_hash: str = "Metadata hash"
    algorand__network: str = "Network"
    algorand__non_participation: str = "Non-participation"
    algorand__note: str = "Note"
    algorand__on_completion: str = "On completion"
    algorand__participating: str = "Participating"
    algorand__payment: str = "Payment"
    algorand__receiver: str = "Receiver"
    algorand__reject_version: str = "Reject version"
    algorand__rekey_to: str = "Rekey To"
    ...
    algorand__source: str = "Source"
    algorand__state_proof_pk: str = "State proof PK"
    algorand__status: str = "Status"
    algorand__title: str = "Algorand"
    algorand__total_supply: str = "Total Supply"
    algorand__total_units: str = "Total units"
    algorand__tx_index_template: str = "Transaction {0}/{1}"
    algorand__unfreeze: str = "Unfreeze"
    algorand__unfrozen: str = "Unfrozen"
